...
var skill_model_1 = require('../../model/skill/skill/skill.model');
...
var SkillSelectionComponent = (function () {
    ...
    SkillSelectionComponent.prototype.ngOnInit = function () {
        this.skill = new skill_model_1.SkillModel("Bla", "Lets you do something", "", "", [new __1.Effect(__1.PropertyProvider.ARMOR, 15, 50)], []);
    };
    __decorate([
        core_1.Input(), 
